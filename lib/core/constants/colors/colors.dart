...
/* NEW COLORS */
const Color cMaroon = Color(0xFF803434);
const Color cCreamyBrown = Color(0xFFF5E2CE);
const Color cLightBeige = Color(0xFFE7E8D1);
const Color cMutedTeal = Color(0XFFA7BEAE);
const Color cDustyRose = Color(0XFFE3867D);
const Color cSoftBlueGray = Color(0XFFCEE6F2);
const Color cMauve = Color(0XFF962E2A);
